...
async def start_handler(event):
    msg = "Hello This is Ayush Tor-Toolkit Bot which is made for leeching all your Torrents , Magnet Links , Direct URL's to Telegram.."
...
async def about_me(message):
    ...
    msg = (
        "<b>Name</b>: <code>Ayush TTK-1</code>\n"
